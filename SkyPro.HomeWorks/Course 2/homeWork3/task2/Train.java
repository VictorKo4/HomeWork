...
public class Train extends Transport {
    ...
    public Train(String brand, String model, String bodyColor, int yearOfRelease,
                 String country, int maxSpeed, int priceTrip, double travelTime,
    ...
    public static void trains() {
        ...
        train[0] = new Train("Ласточка", "B-901", "Синий", 2011,
                "Россия", 301, 3500, 0, "Беларусский вокзал", "Минск-Пассажирский", 11);
        train[1] = new Train("Ленинград", "D-125", "Зеленый", 2019,
                "Россия", 270, 1700, 3.15, "Ленинградский вокзал", "Ленинград-Пассажирский", 8);
    ...
    public String toString() {
        return "Поезд - " + getBrand() + " " + getModel() + ", " + getYearOfRelease() + " года выпуска, производства " + getCountry() + ". Скорость: " + getMaxSpeed() +". Цвет: " + getBodyColor() + '\n'
